  ...
  <!-- Table -->
  <table id="<#=eleBean.serialNumber#>-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
  <!-- header -->
            ...
            <tr class=''>
              <!-- <td></td> -->
                <#for(c=0;c<elements.length;c++){#>
                    <th  class='item' elementId="<#=elements[c].element.id#>"><#=elements[c].element.name#>
                      <#if(editAble&&c>0){#>
