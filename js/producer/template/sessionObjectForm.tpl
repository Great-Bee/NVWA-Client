  ...
  <div class="panel-body">
    <form class="form-horizontal" role="form">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input fieldName="name" type="text" class="form-control"  placeholder="Session条件名称" required="true"/>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input fieldName="alias" type="text" class="form-control"  placeholder="别名,唯一" required="true" <#if(config.formType!='add'){#>readonly="readonly"<#}#>/>
                    </div>
                </div>
            </div>                
        </div>
        <div class="row">            
            <div class="col-md-12">
                <div class="form-group">
                    <label  class="col-md-2 control-label">SessionKey</label>
                    <div class="col-md-10">
                        <input fieldName="sessionKey" type="text" class="form-control"  placeholder="Session Key" required="true" <#if(config.formType!='add'){#>readonly="readonly"<#}#>/>
                    </div>
                </div>
            </div>         
        </div>
