        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input fieldName="appName" type="text" class="form-control"  placeholder="APP名称" <#if(config.formType=='view'){#>readonly="readonly"<#}#>/>
                    </div>
                </div>
            </div>  
            <div class="col-md-6">
                <div class="form-group">
                    <label  class="col-md-4 control-label">App类型</label>
                    <div class="col-md-8 appType">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input fieldName="token" type="text" class="form-control"  readonly="readonly"/>
                    </div>
                </div>
            </div>  
        </div>  
