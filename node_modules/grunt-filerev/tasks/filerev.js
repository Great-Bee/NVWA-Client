  ...
  grunt.registerMultiTask('filerev', 'File revisioning based on content hashing', function() {
    ...
    eachAsync(this.files, function(el, i, next) {
      ...
      el.src.forEach(function(file) {
        ...
        if (ext === '.js' || ext === '.css' || ext === '.tpl') {

          var oldFileName = file.split('/')[file.split('/').length - 1];
          var newFileName = resultPath.split('/')[resultPath.split('/').length - 1];
          var newDifinePath = ext.replace('.', '') + '/' + newFileName;
          // console.log(file);
          // console.log(newDifinePath);

          // if (ext === '.js') {
          //   eachAsync(t.files, function(ell, ii, nextt) {
          //     console.log(ell);
          //   })
          // }


          // var output = filerev.summary;
          // eachAsync(output, function(k, v) {
          //   console.log(v);
          // });
          // el.src.forEach(function(file) {
          //   console.log(file);
          ...
          // console.log(resultPathMap);
          // console.log(map);
          // console.log(grunt.file.exists(map));
